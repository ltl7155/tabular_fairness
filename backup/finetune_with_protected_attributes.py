...
X_train, X_val, y_train_income, y_val_income, y_sex_train, y_sex_val, constraint = joblib.load('data/adult.data')
#
...
if __name__ == '__main__':
    ...
    for frozen_layer in frozen_layers:
        ...
        history = model.fit(x=X_train, y=y_train_labels, epochs=20,
                            validation_data=(X_val, y_val_labels))
        # save model.
        model_name = 'models/finetuned_models_protected_attributes/' + args.attr + '_adult_model_' + str(frozen_layer) + "_" + str(round(history.history["val_acc"][-1], 3)) + '.h5'
