...
if __name__=="__main__":
    ...
    print (args)
    assert args.labels is None , "this is a 10-classes experiment, if you want get binary EXP, please check ../mnist_flip_fairness"
    ...
    label_choices= None#[int(x) for x in label_choices]
    ...
    args_info_dict.update({"ori_reporter":ret_info_ori["reporter"], "flip_reporter":ret_info_flip["reporter"],"inconsistent_c": np.sum(y_pred_ori!=y_pred_flp).tolist(),"total":len(y_pred_flp)  })
