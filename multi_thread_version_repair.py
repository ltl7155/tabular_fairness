...
def construct_model(neurons, top_layer, name, min, max, need_weights=True):
    ...
    d1 = ScaleLayer(30, min, max, 1, name='scalelayer1')
    layer2 = keras.layers.Dense(20, name="layer2")
    d2 = ScaleLayer(20, min, max, 2, name='scalelayer2')
    ...
    d4 = ScaleLayer(15, min, max, 4, name='scalelayer4')
    layer5 = keras.layers.Dense(10,name="layer5")
    d5 = ScaleLayer(10, min, max, 5, name='scalelayer5')
    layer6 = keras.layers.Dense(1, activation="sigmoid", name="layer6")
...
if __name__ == '__main__':
    ...
    for k in para_res.keys():
        if para_res[k][0] > 0.88 and para_res[k][1] > 0.95:
            print(k, para_res[k])